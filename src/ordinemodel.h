...
public:
    ...
    void clear();
    bool completaOrdine(const int, const float, const int, const QString, const QString nomeCassa, const float percentualeSconto, const float importoSconto, int &numTessere);
