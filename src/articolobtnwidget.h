...
class ArticoloBtnWidget : public QPictureButton
{
    Q_OBJECT
public:
    explicit ArticoloBtnWidget(int id, int idRep, int numRiga, int numColonna, QMap<QString, QVariant>* , QWidget *parent = 0);
    ...
    void setVisualizzaPrezzo(const bool valore) {
        visualizzaPrezzo = valore;
    }
    bool isGestioneMenu() {
        return gestioneMenu;
    }
    void setGestioneMenu(bool val) {
        gestioneMenu = val;
    }
